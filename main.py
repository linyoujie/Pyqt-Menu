...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.open_close_side_bar_btn.clicked.connect(lambda: self.slideRightMenu())

        self.ui.pushButton_10.clicked.connect(lambda: self.slideLeftMenu())
        self.ui.pushButton_11.clicked.connect(lambda: self.slideLeftMenu())
        self.ui.pushButton_12.clicked.connect(lambda: self.slideLeftMenu())
